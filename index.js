...
async function main() {
    ...
    for (const weekend of upcomingWeekends) {
        ...
        await page.goto(`https://www.kiwi.com/en/search/tiles/${DEPARTURE_CITY_URL_PARAM}/${DESTINATION_CITY_URL_PARAM}/${from}/${to}?sortAggregateBy=price`);
